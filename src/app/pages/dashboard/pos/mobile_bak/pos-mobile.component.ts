...
export class PosMobileBakComponent implements OnInit, AfterViewInit, OnDestroy {
  // Services
  ...
  async showCompletedOrderReceipt(): Promise<void> {
    try {
      ...
      if (receiptData) {
        ...
        this.router.navigate(['/pos/mobile-bak/receipt-preview'], {
